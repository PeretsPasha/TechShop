...
import com.example.techshop.adapters.CartListAdapter;
import com.example.techshop.databinding.CartRowBinding;
...
public class CartFragment extends Fragment implements CartListAdapter.CartInterface{
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        fragmentCartBinding.cartRecyclerView
        ...
        shopViewModel.getTotalPrice().observe(getViewLifecycleOwner(), new Observer<Double>() {
            ...
            public void onChanged(Double aDouble) {
                fragmentCartBinding.orderTotalTextView.setText("Повна сума: $ " + aDouble.toString());
            }
        });
